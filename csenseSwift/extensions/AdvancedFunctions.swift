...
public func isCalledRecursive(callingFunction: String = #function, className: String) -> Bool {
    ...
    //we are a function, and of cause, this call will be performed in the interesting function, thus we are to skip that as well. so we skip 1 more iff we have objc to go though...
